import { ConnectButton as CB, ConnectButtonCustomization } from '@tuwaio/nova-connect/components';
...
export function ConnectButton() {
  ...
  const customization = useMemo<ConnectButtonCustomization>(
    () => ({
      classNames: {
  ...
  return <CB transactionPool={transactionPool} customization={customization} />;
}
