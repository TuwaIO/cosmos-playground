...
export const TransactionsBlockWrapper = () => {
  ...
  return (
    <div className="p-4 relative">
      <div className="m-auto w-full max-w-md h-auto min-h-[680px] bg-[var(--tuwa-bg-secondary)] rounded-[var(--tuwa-rounded-corners)] border border-[var(--tuwa-border-primary)] overflow-hidden flex flex-col relative">
        {/* Header */}
        ...
        <div className="flex-1 p-8 space-y-8">
          ...
          <div className="space-y-6 flex-1">
            <div className="bg-[var(--tuwa-bg-primary)] rounded-[var(--tuwa-rounded-corners)] p-4 border border-[var(--tuwa-border-primary)] min-h-[100px] flex flex-col justify-center">
        ...
        <footer className="bg-[var(--tuwa-bg-primary)] px-4 py-4 border-t border-[var(--tuwa-border-primary)] flex-shrink-0 h-16 flex items-center justify-center">
          <div className="flex items-center space-x-2 text-xs text-[var(--tuwa-text-tertiary)] font-[DM_Mono] flex-wrap gap-1 items-center justify-center">
            ...
            >
              <span className="font-medium text-[var(--tuwa-text-accent)] leading-none">TUWA</span>
            </a>
